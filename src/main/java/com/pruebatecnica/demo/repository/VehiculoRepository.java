...
public interface VehiculoRepository extends JpaRepository<Vehiculo, String> {
    ...
    @Query(value = "SELECT v.placa as placa, tv.tipo as tipo_vehiculo, v.marca as marca, v.modelo as modelo, v.color as color, iv.fecha_hora_ingreso as fechaHoraIngreso " +
            "FROM vehiculo v " +
